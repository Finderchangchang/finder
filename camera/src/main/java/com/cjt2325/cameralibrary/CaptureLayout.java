...
public class CaptureLayout extends FrameLayout {
    ...
    ChangeStateListener stateListener;

    public void setStateListener(ChangeStateListener stateListener) {
    ...
    private void initView() {
        ...
        //拍照按钮
        btn_capture = new CaptureButton(getContext(), (int) (button_size / 1.5f));
