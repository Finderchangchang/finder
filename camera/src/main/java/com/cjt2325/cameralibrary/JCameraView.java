...
import com.cjt2325.cameralibrary.listener.ChangeStateListener;
...
//    private static final String TAG = "JCameraView";
    ...
    private TextView image_time; //倒计时器
    ...
    private void initView() {
        ...
        image_time = (TextView) view.findViewById(R.id.image_time);
        ...
        timer = new CountDownTimer(60000, 1000) {// 第一个参数是总共时间，第二个参数是间隔触发时间
            @Override
            public void onTick(long millisUntilFinished) {
                image_time.setText(millisUntilFinished / 1000 + "");
            ...
            public void onFinish() {
                ...
                machine.stopRecord(false, 60000);
            }
        };
        setFlashRes();
        ...
        mSwitchCamera.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mFlashLamp.setImageResource(R.drawable.ic_deng_normal);
        ...
        mCaptureLayout.setStateListener(new ChangeStateListener() {

            @Override
            public void change() {
                result = !result;
                Log.i("result----", result + "");
                mCaptureLayout.setLeftImg(result);
            }
        });
        //确认 取消
...
//                    Log.i("CJT", "result = " + (result - firstTouchLength));
    ...
    private void setFlashRes() {
        switch (type_flash) {
            case TYPE_FLASH_ON:
                mFlashLamp.setImageResource(R.drawable.ic_deng);
//                machine.flash(Camera.Parameters.FLASH_MODE_ON);
                CameraInterface.getInstance().setFlashMode("open");
                break;
            case TYPE_FLASH_OFF:
                mFlashLamp.setImageResource(R.drawable.ic_deng_normal);
                CameraInterface.getInstance().setFlashMode("close");
